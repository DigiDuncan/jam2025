...
class UITestView(View):
    def __init__(self) -> None:
        ...
        self.textbox = TobyScriptTextbox(XYWH(self.center_x, self.center_y, 500, 300), 22, "GohuFont 11 Nerd Font Mono", cps = 20, beep = beep)
    ...
    def on_key_press(self, symbol: int, modifiers: int) -> bool | None:
        if symbol == arcade.key.ENTER:
            self.textbox.show(R"\W* Howdy^2!&* I'm\Y FLOWEY\W.^2 &* \YFLOWEY\W the \YFLOWER\W!/")
